...
public class PendingMessagesActivity extends Activity {
	...
	private static final int DHIS_EXPORT_TO_XML = Menu.FIRST + 5;
	...
	private void populateMenu(Menu menu) {
		 ...
		 * Dhis items
		 */
		i = menu.add(Menu.NONE, DHIS_EXPORT_TO_XML, Menu.NONE,
				R.string.dhis_export_to_xml);
	...
	private boolean applyMenuChoice(MenuItem item) {
		...
		case DHIS_EXPORT_TO_XML:
			Util.showToast(PendingMessagesActivity.this, R.string.dhis_export_to_xml);
			return (true);
	...
	private void dhisExportAllToXml(){
		
	}
	
	private void dhisGetMappingFiles(){
		getDhisMappingFilesService = new Intent(this,
				MappingFilesReceiverService.class);
